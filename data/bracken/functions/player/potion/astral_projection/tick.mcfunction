...
execute as @e[type=marker,tag=bp.astral_marker] at @s if score @p[tag=bp.target10] bp.world_player_id = @s bp.world_player_id unless entity @p[tag=bp.target10,distance=..200] run function bracken:player/potion/astral_projection/effect_end
