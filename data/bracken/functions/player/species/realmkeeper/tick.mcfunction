...
execute if score @s bp.health matches 18.. run effect give @s[predicate=bracken:muchlesslightlevel,scores={bp.longtick=40}] minecraft:absorption 9 2 true
execute if predicate bracken:full_gold run effect give @s[predicate=bracken:muchlesslightlevel,scores={bp.longtick=40}] minecraft:absorption 9 2 true
