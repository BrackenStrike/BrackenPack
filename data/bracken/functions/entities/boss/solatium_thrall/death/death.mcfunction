...
summon fireball ~ ~10 ~ {ExplosionPower:10b,power:[0.0,-0.01,0.0],CustomName:'{"translate":"Thrall\'s Retribution","color":"gold"}',Item:{id:"minecraft:soul_fire",Count:1b,components:{"minecraft:enchantment_glint_override":1b}}}
