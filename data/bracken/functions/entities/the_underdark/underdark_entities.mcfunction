...
execute at @e[type=zombie_villager,distance=..200,limit=1,sort=nearest] run summon area_effect_cloud ~ ~ ~ {CustomNameVisible:0b,Radius:15f,RadiusPerTick:-.01f,Duration:1000,Color:11718557,potion_contents:{custom_color:16711680,custom_effects:[{id:"minecraft:slowness",amplifier:3,duration:60},{id:"minecraft:instant_damage",amplifier:0,duration:60},{id:"minecraft:nausea",amplifier:2,duration:60},{id:"minecraft:poison",amplifier:1,duration:60}]},CustomName:'{"translate":"Poisonous Gas"}'}
