...
attribute @s[scores={bp.glacium=10}] minecraft:player.block_break_speed modifier add e0a79d96-ec86-4e7c-9ec7-37ad7ee38a14 "bp.glacium_blockbreak" -1.2 add_multiplied_base
attribute @s[scores={bp.glacium=10}] minecraft:generic.armor_toughness modifier add e0a79d96-ec86-4e7c-9ec7-37ad7ee38a14 "bp.glacium_blockbreak" -1 add_multiplied_base
