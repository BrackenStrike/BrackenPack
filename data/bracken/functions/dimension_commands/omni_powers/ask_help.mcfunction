...
tellraw @s [ \ 
    ...
    {"text":"/trigger OMNI.TELEPORT : teleports you to the nearest player within 100 blocks or teleports players within a 100 blocks to you. Both the teleported player and the recipient must have no items in their left and right hands.\n", "color":"green","obfuscated":"false"}, \
