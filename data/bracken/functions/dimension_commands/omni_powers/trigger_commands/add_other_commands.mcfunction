##########################################################
# Description: Extension of bracken:load to add omnidrome non-book scoreboards for trigger commands
...
scoreboard objectives add _OMNI.BUILD.road_east dummy
scoreboard objectives add _OMNI.BUILD.road_west dummy
scoreboard objectives add _OMNI.BUILD.pillar dummy
scoreboard objectives add _OMNI.BUILD.cyber_tree dummy
scoreboard objectives add _OMNI.BUILD.pyramid dummy
scoreboard objectives add _OMNI.BUILD.end_island dummy
scoreboard objectives add _OMNI.BUILD.sculk_patch dummy
scoreboard objectives add _OMNI.BUILD.single_block dummy

scoreboard objectives add _OMNI.CLEAR.debris dummy
scoreboard objectives add _OMNI.CLEAR.material dummy

scoreboard objectives add _OMNI.SUMMON.lightning dummy
scoreboard objectives add _OMNI.SUMMON.construct dummy
scoreboard objectives add _OMNI.SUMMON.theoretical_blaze dummy
scoreboard objectives add _OMNI.SUMMON.theoretical_creeper dummy
scoreboard objectives add _OMNI.SUMMON.theoretical_mount dummy
scoreboard objectives add _OMNI.SUMMON.theoretical_ravager dummy
scoreboard objectives add _OMNI.SUMMON.theoretical_tnt dummy
scoreboard objectives add _OMNI.SUMMON.theoretical_pirate dummy
scoreboard objectives add _OMNI.SUMMON.theoretical_snowman dummy
scoreboard objectives add _OMNI.SUMMON.theoretical_warden dummy
scoreboard objectives add _OMNI.SUMMON.pulse dummy
scoreboard objectives add _OMNI.SUMMON.disruptor_beam dummy

scoreboard objectives add _OMNI.ENABLE.flight dummy
scoreboard objectives add _OMNI.ENABLE.sprint dummy
scoreboard objectives add _OMNI.DISABLE.flight dummy
scoreboard objectives add _OMNI.DISABLE.sprint dummy

#scoreboard objectives add _OMNI.TELEPORT.to_nearest_nearby_player dummy
#scoreboard objectives add _OMNI.TELEPORT.from_nearby_players dummy

scoreboard objectives add _OMNI.ASK.help dummy