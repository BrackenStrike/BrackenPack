...
execute unless entity @s[scores={bp.dimension_check=1..}] run tellraw @s ["",{"translate":"Chunks Loading... Teleportation to "},{"translate":"Sanctum","color":"gray"},{"translate":" will occur in a moment."}]
