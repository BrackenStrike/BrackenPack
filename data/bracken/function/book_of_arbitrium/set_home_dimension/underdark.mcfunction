...
execute unless entity @s[scores={bp.dimension_check=1..}] run tellraw @s ["",{"translate":"Chunks Loading... Teleportation to "},{"translate":"the Underdark","color":"dark_gray"},{"translate":" will occur in a moment."}]
