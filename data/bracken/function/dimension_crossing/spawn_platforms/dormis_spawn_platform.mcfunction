...
execute in bracken:dormis run setblock ~ 240 ~ minecraft:structure_block{posY:-2,posX:-4,posZ:-4,powered:0b,mode:"LOAD",ignoreEntities:0b,name:"bracken:spawn_platforms/dormis_spawn_platform"}
