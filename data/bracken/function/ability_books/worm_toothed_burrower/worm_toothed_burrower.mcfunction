...
summon giant ~ ~20 ~ {Tags:["bp.tooth","bp.entity","bp.ability_books"],Silent:1b,Invulnerable:1b,CustomNameVisible:0b,CustomName:'{"text":"Dinnerbone"}',HandItems:[{id:"minecraft:netherite_pickaxe",Count:1b,components:{"minecraft:item_model":"bracken:feilfri"}},{}],active_effects:[{id:"minecraft:invisibility",amplifier:1b,duration:-1,show_particles:0b}]}
