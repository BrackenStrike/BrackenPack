...
## PEARL TP
#execute if entity @s[type=minecraft:ender_pearl,tag=bp.pearl] run return run function bracken:entity/misc/pearl_travel/pearl_tick

## OTHER ENTITIES
function bracken:entity/misc/other_entities_tick