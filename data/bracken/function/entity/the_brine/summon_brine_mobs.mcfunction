...
#distorted nereid
data merge entity @n[type=drowned,distance=..100,tag=!distorted_nereid,tag=!bp.safe] {CanBreakDoors:1b,Tags:["bp.distorted_nereid"],CustomName:"Distorted Nereid",equipment:{feet:{id:"minecraft:golden_boots",count:1,components:{"minecraft:trim":{material:"minecraft:amethyst",pattern:"minecraft:tide"},"minecraft:enchantments":{"depth_strider":3,"mending":1}}},legs:{id:"minecraft:diamond_leggings",count:1,components:{"minecraft:trim":{material:"minecraft:amethyst",pattern:"minecraft:tide"},"minecraft:enchantments":{"mending":1}}},chest:{id:"minecraft:golden_chestplate",count:1,components:{"minecraft:trim":{material:"minecraft:amethyst",pattern:"minecraft:tide"},"minecraft:enchantments":{"mending":1}}},head:{id:"minecraft:bamboo",count:1,components:{"minecraft:item_model":"bracken:shadows/distorted_nereid","minecraft:enchantments":{"binding_curse":1,"vanishing_curse":1}}},mainhand:{id:"minecraft:trident",count:1,components:{"minecraft:enchantments":{"channeling":1,"impaling":1}}}}}
