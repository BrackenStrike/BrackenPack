...
data merge entity @n[type=bat,distance=..200,tag=!bp.giant_bat] {CustomNameVisible:0b,CustomName:{"translate":"Jotun Bat"},DeathLootTable:"bracken:entity/the_underdark/giant_bat",NoAI:1b,Tags:[bp.giant_bat,bp.entity],attributes:[{id:"minecraft:scale",base:4}]}
