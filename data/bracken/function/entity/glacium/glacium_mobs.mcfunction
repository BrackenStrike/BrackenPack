...
## Spearkin
data merge entity @n[type=skeleton,distance=..100,tag=!bp.frostkin2] {CustomNameVisible:0b,attributes:[{id:armor,base:20}],CustomName:{"translate":"Spearkin","color":"blue","italic":false},DeathLootTable:"bracken:entity/glacium/frostkin2",Silent:1b,Tags:[bp.frostkin2],PersistenceRequired:0b,equipment:{legs:{id:"minecraft:chainmail_leggings",Count:1b,components:{"minecraft:enchantments":{"minecraft:vanishing_curse":1,"minecraft:protection":3}}},feet:{id:"minecraft:iron_boots",Count:1b,components:{"minecraft:item_model":"bracken:average_weapons/cryolith/boots","minecraft:equippable":{asset_id:'bracken:cryolith',slot:'feet'},"minecraft:enchantments":{"minecraft:vanishing_curse":1,"minecraft:protection":1,"bracken:quenching_fix":1}}},chest:{id:"minecraft:iron_chestplate",Count:1b,components:{"minecraft:enchantments":{"minecraft:vanishing_curse":1,"minecraft:protection":3}}},mainhand:{id:"minecraft:iron_spear",Count:1b,components:{"minecraft:custom_name":{"translate":"Iron Spear","italic":false},"minecraft:enchantments":{"minecraft:vanishing_curse":1,"minecraft:sharpness":5,"bracken:freezing_fix":1}}},head:{id:"minecraft:bamboo",Count:1b,components:{"minecraft:item_model":"bracken:shadows/frostkin2","minecraft:enchantment_glint_override":false,"minecraft:enchantments":{"minecraft:vanishing_curse":1}}}}}
...
## Slayerkin
data merge entity @n[type=wither_skeleton,distance=..100,tag=!bp.frostkin3,tag=!bp.safe] {CustomNameVisible:0b,CustomName:{"translate":"Slayerkin","color":"blue","italic":false},DeathLootTable:"bracken:entity/glacium/frostkin5",Silent:1b,Tags:[bp.frostkin3],PersistenceRequired:0b,attributes:[{id:armor,base:20},{id:"minecraft:movement_speed",base:.4},{id:"minecraft:scale",base:0.75}],equipment:{chest:{id:"minecraft:leather_chestplate",Count:1b,components:{"minecraft:dyed_color":0,"minecraft:enchantments":{"minecraft:vanishing_curse":1,"minecraft:protection":2}}},offhand:{id:"minecraft:iron_sword",Count:1b,components:{"minecraft:custom_name":{"translate":"Cyolith Sickle","italic":false},"minecraft:attribute_modifiers":[{id:"attack_damage",type:"entity_interaction_range",amount:2,operation:"add_value",slot:"offhand"}],"minecraft:item_model":"bracken:average_weapons/cryolith/sickle","minecraft:enchantments":{"minecraft:vanishing_curse":1,"minecraft:sharpness":5,"bracken:freezing_fix":1}}},mainhand:{id:"minecraft:iron_sword",Count:1b,components:{"minecraft:custom_name":{"translate":"Cyolith Sickle","italic":false},"minecraft:attribute_modifiers":[{id:"entity_interaction_range",type:"attack_damage",amount:2,operation:"add_value",slot:"mainhand"}],"minecraft:item_model":"bracken:average_weapons/cryolith/sickle","minecraft:enchantments":{"minecraft:vanishing_curse":1,"minecraft:sharpness":5,"bracken:freezing_fix":1}}},head:{id:"minecraft:bamboo",Count:1b,components:{"minecraft:item_model":"bracken:shadows/frostkin5","minecraft:enchantment_glint_override":false,"minecraft:enchantments":{"minecraft:vanishing_curse":1}}}}}
