...
summon firework_rocket ~ ~ ~ {NoGravity:1b,LifeTime:0,CustomName:{"translate":"vicefrost attack","color":"blue","bold":true},FireworksItem:{id:firework_rocket,count:1,components:{"minecraft:fireworks":{explosions:[{shape:"star",colors:[1572848],fade_colors:[5735679],has_trail:1b}]}}}}
