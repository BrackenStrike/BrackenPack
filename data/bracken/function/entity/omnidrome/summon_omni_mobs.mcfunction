...
## NUTRI-BLAST
execute as @n[type=slime,distance=..100,tag=!bp.safe] at @s run function bracken:entity/omnidrome/summons/nutri_blast_setup

## ADAPTER-T
execute as @n[type=silverfish,distance=..100,tag=!bp.safe] at @s run function bracken:entity/omnidrome/summons/adapter_t_setup

## IRON TALOS GOLEM
execute as @n[type=zombie_horse,distance=..100,tag=!bp.safe] at @s run function bracken:entity/omnidrome/summons/iron_talos_setup
