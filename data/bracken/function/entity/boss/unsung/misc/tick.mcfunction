...
execute if score @s bp.unsung matches ..0 run function bracken:entity/boss/unsung/misc/attack_selector
scoreboard players remove @s bp.unsung 1

#armor stand swords
execute unless score @s bp.speed matches 1.. at @e[type=minecraft:armor_stand,tag=bp.5,distance=..20,limit=1] run function bracken:entity/boss/unsung/misc/default_speed
...
execute if score @s bp.speed matches 1.. at @e[type=minecraft:armor_stand,tag=bp.5,distance=..20,limit=1] run function bracken:entity/boss/unsung/misc/fast_speed
...
execute if entity @s[scores={bp.slash=..0}] at @e[type=minecraft:armor_stand,tag=bp.sword,distance=..20] as @a[distance=..1] run function bracken:entity/boss/unsung/attacks/slash_damage
...
#death
execute if entity @s[scores={bp.unsung.health=..20}] run function bracken:entity/boss/unsung/misc/death
