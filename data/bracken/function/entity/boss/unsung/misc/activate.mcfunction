...
data merge entity @s {DeathLootTable:"bracken:entity/boss/unsung",attributes:[{id:"follow_range",base:80}],drop_chances:{mainhand:0f,offhand:0.085f},equipment:{mainhand:{id:"minecraft:netherite_sword",count:1b,components:{"minecraft:item_name":"Paxmaker Sword","minecraft:rarity":"epic","minecraft:repair_cost":100,"minecraft:item_model":"bracken:paxmaker_sword","minecraft:enchantments":{"minecraft:knockback":7,"minecraft:smite":7,"minecraft:sweeping_edge":7,"minecraft:vanishing_curse":1}} },feet:{id:"minecraft:leather_boots",count:1,components:{"minecraft:rarity":"epic","minecraft:repair_cost":100,"minecraft:enchantments":{"minecraft:protection":4,"minecraft:vanishing_curse":1,"minecraft:depth_strider":3},"minecraft:dyed_color":0}},chest:{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:rarity":"epic","minecraft:repair_cost":100,"minecraft:enchantments":{"minecraft:protection":4,"minecraft:vanishing_curse":1},"minecraft:dyed_color":0}}},CustomName:"Unsung",Invulnerable:0b,NoGravity:0b,NoAI:0b}
tag @s add bp.active

tellraw @a[distance=..25] ["",{"text":"<"},{"translate":"Unsung","color":"light_purple"},{"text":"> "},{"text":"(;︵;)(⋋_⋌)(☉_☉)(^◡^)","color":"white"}]
