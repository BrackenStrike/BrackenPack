...
execute if score #1 bp.math.out matches 0 run function bracken:entity/boss/unsung/attacks/explode
execute if score #1 bp.math.out matches 1 run function bracken:entity/boss/unsung/attacks/slash
