...
summon minecraft:zombie ~ ~1 ~ {Johnny:1b,NoAI:1b,Invulnerable:1b,DeathLootTable:"bracken:entity/boss/unsung",Health:400,Tags:[bp.entity,bp.boss,bp.unsung],IsImmuneToZombification:1,PersistenceRequired:1b,Glowing:0,attributes:[{id:"follow_range",base:80},{id:"knockback_resistance",base:0.1f},{id:"movement_speed",base:0.4f},{id:max_health,base:400},{id:"attack_damage",base:20}],Silent:1,equipment:{mainhand:{id:"minecraft:netherite_sword",Count:1b,components:{"minecraft:item_name":{"translate":"Paxmaker Sword"},"minecraft:rarity":"epic","minecraft:repair_cost":100,"minecraft:item_model":"bracken:paxmaker_sword","minecraft:enchantments":{"minecraft:knockback":7,"bracken:spectrality":1,"minecraft:smite":7,"minecraft:sweeping_edge":7,"minecraft:vanishing_curse":1}} }},drop_chances:{mainhand:0f,offhand:0.085f},active_effects:[{id:"minecraft:fire_resistance",amplifier:0,duration:-1,show_particles:0b},{id:"minecraft:jump_boost",amplifier:2,duration:-1,show_particles:0b},{id:"minecraft:invisibility",amplifier:0,duration:-1,show_particles:0b}]}
