...
execute if score @s[name=!Rocco] bp.thrall matches ..0 if score #1 bp.math.out matches 0 run function bracken:entity/boss/solatium_thrall/attacks/cloud
execute if score @s[name=!Rocco] bp.thrall matches ..0 if score #1 bp.math.out matches 1 run function bracken:entity/boss/solatium_thrall/attacks/minions
execute if score @s[name=!Rocco] bp.thrall matches ..0 if score #1 bp.math.out matches 2 run function bracken:entity/boss/solatium_thrall/attacks/blast
execute if score @s[name=!Rocco] bp.thrall matches ..0 if score #1 bp.math.out matches 3 run function bracken:entity/boss/solatium_thrall/attacks/fireball
...
#death
execute if entity @s[scores={bp.thrall.health=..20},tag=!bp.set_wtb] run function bracken:entity/boss/solatium_thrall/death/death
...
#passive buffs
execute at @a[distance=..100,scores={bp.longtick=20}] run function bracken:entity/boss/solatium_thrall/misc/passive_buffs
