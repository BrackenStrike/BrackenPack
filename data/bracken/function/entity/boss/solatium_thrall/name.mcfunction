...
function bracken:item/ability_books/worm_toothed_burrower/worm_toothed_burrower

tellraw @a[distance=..20] {"translate":"Thrall: My true name... Thank you.\"","color":"gold","bold":true}
playsound minecraft:block.respawn_anchor.ambient hostile @a[scores={bp.10_second=10},distance=..10] ~ ~ ~ 100 0
