...
scoreboard players set @n[type=elder_guardian,tag=bp.the_disruptor.inactive] bp.boss_state_cd 0
scoreboard players set @n[type=elder_guardian,tag=bp.the_disruptor.inactive] bp.boss_move_state 0
