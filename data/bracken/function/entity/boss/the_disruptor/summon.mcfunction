...
scoreboard players set @e[type=elder_guardian,tag=bp.the_disruptor.inactive,sort=nearest,limit=1] bp.boss_state_cd 0
scoreboard players set @e[type=elder_guardian,tag=bp.the_disruptor.inactive,sort=nearest,limit=1] bp.boss_move_state 0
