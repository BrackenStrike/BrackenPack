#init
scoreboard players set @s[scores={bp.boss_state_cd=..0}] bp.boss_state_cd 600


#commands
scoreboard players set @s bp.boss_speed 50
execute store result score @s bp.xmansion run data get entity @p[distance=..50] Pos[0]
execute store result score @s bp.ymansion run data get entity @p[distance=..50] Pos[1]
execute store result score @s bp.zmansion run data get entity @p[distance=..50] Pos[2]
