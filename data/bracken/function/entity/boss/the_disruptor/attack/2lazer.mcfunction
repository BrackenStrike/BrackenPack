...
#commands
#execute if score disrupt.cd bp.the_disruptor matches 40 run function bracken:entity/boss/the_disruptor/attack/misc/disrupt
...
execute if score @s bp.dis.attack_cd matches 100.. run function bracken:entity/boss/the_disruptor/move


scoreboard players add @s bp.dis.cd 1
execute if score @s bp.dis.attack_cd matches ..100 if score @s bp.dis.cd matches 20 facing entity @p eyes run function bracken:entity/boss/the_disruptor/attack/lazer/lazersummon
