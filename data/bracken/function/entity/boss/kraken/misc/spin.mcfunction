...
execute if block ^ ^-4 ^18 water run tp @s ~ ~-0.5 ~ ~200 -90
...
execute if entity @s[predicate=bracken:periodic/1s] run function bracken:entity/boss/kraken/misc/whirlpool

#slap
execute positioned ^ ^4 ^ as @e[distance=..15,tag=!bp.kraken] at @s run function bracken:entity/boss/kraken/misc/slap
