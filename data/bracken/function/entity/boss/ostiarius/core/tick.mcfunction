...
execute if score @s bp.prjct_ruin.p matches 1 run function bracken:entity/boss/ostiarius/core/phase/1
execute if score @s bp.prjct_ruin.p matches 2 run function bracken:entity/boss/ostiarius/core/phase/2
execute if score @s bp.prjct_ruin.p matches 3 run function bracken:entity/boss/ostiarius/core/phase/3
...
execute if entity @s[scores={bp.doomsday=125}] run function bracken:entity/boss/ostiarius/core/doom_event

execute if entity @s[scores={bp.doomsday=250}] run function bracken:entity/boss/ostiarius/core/doom_event

execute if entity @s[scores={bp.doomsday=375}] run function bracken:entity/boss/ostiarius/core/doom_event
execute if entity @s[scores={bp.doomsday=375..}] run scoreboard players set @a[distance=..50] bp.pull 10

execute if entity @s[scores={bp.doomsday=499..}] run function bracken:entity/boss/ostiarius/core/doomsday
