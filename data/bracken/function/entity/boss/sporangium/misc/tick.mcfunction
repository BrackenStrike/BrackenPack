...
execute if score @s[tag=!bp.death] bp.sporangium matches ..0 if score #1 bp.math.out matches 0 run function bracken:entity/boss/sporangium/attacks/grow
execute if score @s[tag=!bp.death] bp.sporangium matches ..0 if score #1 bp.math.out matches 1 run function bracken:entity/boss/sporangium/attacks/multiply
execute if score @s[tag=!bp.death] bp.sporangium matches ..0 if score #1 bp.math.out matches 2 run function bracken:entity/boss/sporangium/attacks/nema
execute if score @s[tag=!bp.death] bp.sporangium matches ..0 if score #1 bp.math.out matches 3 run function bracken:entity/boss/sporangium/attacks/block
...
execute if score @s bp.nema matches 1.. run function bracken:entity/boss/sporangium/misc/poison_arrows

scoreboard players remove @s bp.nema 1


#death
execute if entity @s[scores={bp.sporangium.health=..60},tag=!bp.death,tag=bp.ready,tag=bp.ready2] run function bracken:entity/boss/sporangium/misc/truedeath
