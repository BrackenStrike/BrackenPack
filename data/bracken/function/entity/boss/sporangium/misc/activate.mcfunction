...
data merge entity @s {active_effects:[{id:"minecraft:speed",amplifier:17b,duration:-1,show_particles:0b}],Health:1000f,Invulnerable:0b,NoGravity:0b,NoAI:0b,Size:12,Glowing:0,attributes:[{id:follow_range,base:100},{id:max_health,base:1000},{id:knockback_resistance,base:1},{id:attack_damage,base:30},{id:attack_knockback,base:10}]}
