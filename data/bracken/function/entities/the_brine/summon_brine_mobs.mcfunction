...
#hammerhead
data merge entity @e[type=stray,distance=..100,limit=1,sort=nearest,tag=!bp.hammerhead] {Silent:1b,CustomNameVisible:0b,DeathLootTable:"bracken:entity/the_brine/hammerhead",Health:25f,Tags:["bp.hammerhead"],CustomName:"Sphyrna",equipment:{head:{id:"minecraft:bamboo",count:1,components:{"minecraft:item_model":"bracken:shadows/hammerhead","minecraft:enchantments":{"minecraft:vanishing_curse":1},"minecraft:enchantment_glint_override":false}},mainhand:{id:"minecraft:wooden_sword",count:1,components:{"minecraft:item_model":"bracken:average_weapons/toothed_sword","minecraft:attribute_modifiers":[{id:"attack_damage",type:"attack_damage",amount:6,operation:"add_value",slot:"mainhand"}],"minecraft:enchantments":{"minecraft:vanishing_curse":1},"minecraft:enchantment_glint_override":false}}},attributes:[{id:"minecraft:oxygen_bonus",base:1024},{id:"minecraft:water_movement_efficiency",base:1}]}