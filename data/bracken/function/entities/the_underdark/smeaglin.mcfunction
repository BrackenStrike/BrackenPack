...
execute at @e[type=item,distance=1..2,limit=1,tag=!bp.smeaglin1] run function bracken:entities/the_underdark/ignite


#execute at @e[type=item,distance=1..2,limit=1,tag=!bp.smeaglin1] run advancement grant @a[distance=..10] only bracken:glacium/spite
...
execute at @e[type=creeper,distance=1..2,limit=1,tag=!bp.smeaglin1] run function bracken:entities/the_underdark/creeper