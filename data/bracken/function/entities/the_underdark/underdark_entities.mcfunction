...
execute at @e[type=skeleton,distance=..200,limit=1,sort=nearest] run summon piglin ~ ~ ~ {Silent:1b,DeathLootTable:"bracken:entity/the_underdark/smeaglin",LeftHanded:0b,CanPickUpLoot:1b,IsBaby:1b,IsImmuneToZombification:1b,CannotHunt:0b,Tags:["bp.entity","bp.smeaglin"],CustomName:{"translate":"Smeaglin"},ArmorItems:[{},{},{},{id:"minecraft:bamboo",Count:1b,components:{"minecraft:item_model":"bracken:shadows/smeaglin","minecraft:enchantments":{levels:{"minecraft:vanishing_curse":1,"minecraft:binding_curse":1}}} }],ArmorDropChances:[0.085F,0.085F,0.085F,0.000F],active_effects:[{id:"minecraft:fire_resistance",amplifier:1b,duration:-1,show_particles:1b},{id:"minecraft:invisibility",amplifier:1b,duration:-1,show_particles:0b}],attributes:[{id:movement_speed,base:0.22}]}
