...
execute at @e[type=skeleton,distance=..100,limit=1,sort=nearest] run summon minecraft:stray ~ ~ ~ {PersistenceRequired:0b,HandItems:[{id:"minecraft:trident",Count:1b,components:{"minecraft:custom_name":'{"translate":"Glacium Halberd","italic":false}',"minecraft:enchantments":{levels:{"minecraft:impaling":7}}}},{}],HandDropChances:[0.1000F,0.085F],ArmorItems:[{},{},{},{id:"minecraft:chainmail_helmet",Count:1b}]}
