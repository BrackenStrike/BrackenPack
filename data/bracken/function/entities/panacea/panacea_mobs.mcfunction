...
data merge entity @e[type=zombie,distance=..100,limit=1,sort=nearest,tag=!bp.gothrum1] {CustomName:'{"text":"Gothrum","color":"dark_green"}',CustomNameVisible:0b,Silent:1,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,components:{"minecraft:dyed_color":3684408}},{id:"minecraft:leather_leggings",Count:1b,components:{"minecraft:dyed_color":3684408}},{id:"minecraft:leather_chestplate",Count:1b,components:{"minecraft:dyed_color":3684408}},{id:"minecraft:bamboo",Count:1b,components:{"minecraft:item_name":'"Gothrum Head"',"minecraft:item_model":"bracken:shadows/gothrum_head","minecraft:enchantment_glint_override":false,"minecraft:enchantments":{levels:{"minecraft:vanishing_curse":1}}  }}],ArmorDropChances:[0.085F,0.085F,0.085F,0.000F],Tags:["bp.gothrum1"],DeathLootTable:"bracken:entity/panacea/gothrum1"}
