...
data merge entity @e[type=zombie,distance=..100,limit=1,sort=nearest,tag=!bp.gothrum1] {active_effects:[{id:"minecraft:weaving",amplifier:1,duration:-1,show_particles:1b}],CustomName:{"text":"Gothrum","color":"dark_green"},CustomNameVisible:0b,Silent:1,equipment:{feet:{id:"minecraft:leather_boots",Count:1b,components:{"minecraft:dyed_color":3684408}},legs:{id:"minecraft:leather_leggings",Count:1b,components:{"minecraft:dyed_color":3684408}},chest:{id:"minecraft:leather_chestplate",Count:1b,components:{"minecraft:dyed_color":3684408}},head:{id:"minecraft:bamboo",Count:1b,components:{"minecraft:item_name":"Gothrum Head","minecraft:item_model":"bracken:shadows/gothrum_head","minecraft:enchantment_glint_override":false,"minecraft:enchantments":{levels:{"minecraft:vanishing_curse":1}}  }}},ArmorDropChances:[0.085F,0.085F,0.085F,0.000F],Tags:["bp.gothrum1"],DeathLootTable:"bracken:entity/panacea/gothrum1"}



data merge entity @e[type=skeleton,distance=..100,limit=1,sort=nearest,tag=!bp.ventithrub1] {CustomName:{"text":"Dehydrated Ventithrub","color":"dark_green"},CustomNameVisible:0b,equipment:{mainhand:{id:"minecraft:wooden_axe",Count:1b},head:{id:"minecraft:bamboo",Count:1b,components:{"minecraft:item_name":"Ventithrub Flower","minecraft:item_model":"bracken:shadows/ventithrub_flower","minecraft:enchantment_glint_override":false,"minecraft:enchantments":{levels:{"minecraft:vanishing_curse":1}}  }}},ArmorDropChances:[0.000F,0.000F,0.000F,0.000F],Tags:["bp.ventithrub1"],DeathLootTable:"bracken:entity/panacea/ventithrub1"}
