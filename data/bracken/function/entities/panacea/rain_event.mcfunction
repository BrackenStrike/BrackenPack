...
execute at @e[type=zombie,distance=..100,limit=1,sort=nearest] run summon spider ~ ~ ~ {Silent:1,Tags:["bp.gothrum2","bp.entity","bp.rain_event"],Passengers:[{id:"minecraft:drowned",HandItems:[{id:"minecraft:iron_sword",Count:1b,components:{"minecraft:custom_name":'{"text":"Gothrum Fang"}',"minecraft:item_model":"bracken:gothrum_fang","minecraft:enchantments":{levels:{"bracken:poisoning_fix":1}}}}],CustomName:'{"text":"Gothrum","color":"dark_green"}',active_effects:[{id:"minecraft:weaving",amplifier:1,duration:-1,show_particles:1b}],CustomNameVisible:0b,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,components:{"minecraft:dyed_color":3684408}},{id:"minecraft:leather_leggings",Count:1b,components:{"minecraft:dyed_color":3684408}},{id:"minecraft:leather_chestplate",Count:1b,components:{"minecraft:dyed_color":3684408}},{id:"minecraft:bamboo",Count:1b,components:{"minecraft:item_name":'"Gothrum Head"',"minecraft:item_model":"bracken:shadows/gothrum_head"}}] }],ArmorDropChances:[0.085F,0.085F,0.085F,0.000F],active_effects:[{id:"minecraft:weaving",amplifier:1,duration:-1,show_particles:1b}],DeathLootTable:"bracken:entity/panacea/gothrum2",Health:40f,attributes:[{id:"minecraft:scale",base:2},{id:"minecraft:max_health",base:40},{id:"minecraft:knockback_resistance",base:0.5}]}

tp @e[type=zombie,distance=..100,limit=1,sort=nearest] ~ -512 ~


execute at @e[type=husk,distance=..100,limit=1,sort=nearest] run summon wither_skeleton ~ ~8 ~ {PersistenceRequired:1b,NoAI:0b,CustomName:'{"text":"Mature Ventithrub","color":"dark_green"}',CustomNameVisible:0b,Silent:1,ArmorItems:[{},{},{},{id:"minecraft:bamboo",Count:1b,components:{"minecraft:item_name":'"Ventithrub Flower"',"minecraft:item_model":"bracken:shadows/ventithrub_flower"}}],Tags:["bp.ventithrub2","bp.rain_event","bp.entity"],ArmorDropChances:[0.000F,0.000F,0.000F,0.000F],DeathLootTable:"bracken:entity/panacea/ventithrub3",Health:80f,attributes:[{id:"minecraft:max_health",base:80},{id:"minecraft:scale",base:5},{id:"minecraft:follow_range",base:64},{id:"minecraft:step_height",base:8}]}
tp @e[type=husk,distance=..100,sort=nearest,limit=1] ~ -512 ~

execute at @e[type=skeleton,distance=..100,limit=1,sort=nearest] run summon wither_skeleton ~ ~ ~ {NoAI:0b,CustomName:'{"text":"Ventithrub","color":"dark_green"}',CustomNameVisible:0b,Silent:1,ArmorItems:[{},{},{},{id:"minecraft:bamboo",Count:1b,components:{"minecraft:custom_name":'"Ventithrub Flower"',"minecraft:item_model":"bracken:shadows/ventithrub_flower"}}],Tags:["bp.ventithrub2","bp.rain_event","bp.entity"],ArmorDropChances:[0.000F,0.000F,0.000F,0.000F],DeathLootTable:"bracken:entity/panacea/ventithrub2",Attributes:[{Name:follow_range,Base:64}]}
