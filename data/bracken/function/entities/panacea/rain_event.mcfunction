...
execute at @e[type=zombie,distance=..100,limit=1,sort=nearest] run summon spider ~ ~ ~ {Silent:1,Tags:["bp.gothrum2","bp.entity","bp.rain_event"],Passengers:[{id:"minecraft:drowned",HandItems:[{id:"minecraft:iron_sword",Count:1b}],CustomName:'{"text":"Gothrum","color":"dark_green"}',CustomNameVisible:0b,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,components:{"minecraft:dyed_color":3684408}},{id:"minecraft:leather_leggings",Count:1b,components:{"minecraft:dyed_color":3684408}},{id:"minecraft:leather_chestplate",Count:1b,components:{"minecraft:dyed_color":3684408}},{id:"minecraft:bamboo",Count:1b,components:{"minecraft:item_name":'"Gothrum Head"',"minecraft:item_model":"bracken:shadows/gothrum_head"}}] }],ArmorDropChances:[0.085F,0.085F,0.085F,0.000F],DeathLootTable:"bracken:entity/panacea/gothrum2",Health:40f,attributes:[{id:"minecraft:scale",base:2},{id:"minecraft:max_health",base:40},{id:"minecraft:knockback_resistance",base:0.5}]}
