...
execute at @a[distance=..50] run summon tnt ~ ~20 ~ {HasVisualFire:1b,Glowing:1b,fuse:50,block_state:{id:"minecraft:gold_block"},Tags:["bp.thrall.blast"],CustomName:'{"translate":"Thrall Blast","color":"gold"}'}
