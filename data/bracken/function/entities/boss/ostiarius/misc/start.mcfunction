...
summon giant ~0.5 ~0.5 ~0.5 {CustomName:{"text":"Dinnerbone","color":"green","obfuscated":true},Silent:1b,DeathLootTable:"bracken:entity/boss/ostiarius",Health:400f,PersistenceRequired:1b,NoAI:1b,equipment:{mainhand:{id:"minecraft:ender_eye",Count:1b,components:{"minecraft:item_model":"bracken:ruination_eye"}},offhand:{id:"minecraft:ender_eye",Count:1b,components:{"minecraft:item_model":"bracken:ruination_eye"}}},HandDropChances:[0.000F,0.000F],Tags:["bp.ostiarius.core"],attributes:[{id:max_health,base:400}],active_effects:[{id:"minecraft:invisibility",amplifier:1b,duration:-1,show_particles:0b}]}
