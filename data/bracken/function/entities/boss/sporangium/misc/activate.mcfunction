...
data merge entity @s {active_effects:[{id:"minecraft:speed",amplifier:17b,duration:-1,ShowParticles:0b}],Invulnerable:0b,NoGravity:0b,NoAI:0b,Size:12,Glowing:0,attributes:[{id:generic.follow_range,base:100},{id:max_health,base:1000},{id:generic.knockback_resistance,base:1},{id:generic.attack_damage,base:30},{id:generic.attack_knockback,base:10}]}
tag @s add bp.active
