...
tellraw @s ["",{"text":"[Normal]","color":"yellow","click_event":{"action":"run_command","command":"/function bracken:player/config_menu/normal_nether_height"}},{"text":" "},{"text":"[Incendium]","color":"yellow","click_event":{"action":"run_command","command":"/function bracken:player/config_menu/incendium_nether_height"}}]
...
#tellraw @s ["",{"text":"[Normal]","color":"yellow","click_event":{"action":"run_command","command":"/function bracken:player/config_menu/normal_end_height"}},{"text":" "},{"text":"[Nullscape]","color":"yellow","click_event":{"action":"run_command","command":"/function bracken:player/config_menu/nullscape_end_height"}}]
...
tellraw @s ["",{"text":"[Enable]","color":"green","click_event":{"action":"run_command","command":"/function bracken:player/config_menu/enable_dimensional_travel"}},{"text":" "},{"text":"[Disable]","color":"red","click_event":{"action":"run_command","command":"/function bracken:player/config_menu/disable_dimensional_travel"}}]
...
tellraw @s ["",{"text":"[Enable]","color":"green","click_event":{"action":"run_command","command":"/function bracken:player/config_menu/enable_teams"}},{"text":" "},{"text":"[Disable]","color":"red","click_event":{"action":"run_command","command":"/function bracken:player/config_menu/disable_teams"}}]
...
tellraw @s ["",{"text":"[Enable]","color":"green","click_event":{"action":"run_command","command":"/function bracken:player/config_menu/enable_species"}},{"text":" "},{"text":"[Disable]","color":"red","click_event":{"action":"run_command","command":"/function bracken:player/config_menu/disable_species"}}]
...
tellraw @s ["",{"text":"[Enable]","color":"green","click_event":{"action":"run_command","command":"/function bracken:player/config_menu/enable_bsb"}},{"text":" "},{"text":"[Disable]","color":"red","click_event":{"action":"run_command","command":"/function bracken:player/config_menu/disable_bsb"}}]
...
tellraw @s ["",{"text":"[Enable]","color":"green","click_event":{"action":"run_command","command":"/function bracken:player/config_menu/enable_ability_books"}},{"text":" "},{"text":"[Disable]","color":"red","click_event":{"action":"run_command","command":"/function bracken:player/config_menu/disable_ability_books"}}]
...
tellraw @s ["",{"text":"[Enable]","color":"green","click_event":{"action":"run_command","command":"/function bracken:player/config_menu/enable_portal_keys"}},{"text":" "},{"text":"[Disable]","color":"red","click_event":{"action":"run_command","command":"/function bracken:player/config_menu/disable_portal_keys"}}]
