...
execute if entity @e[distance=..3,type=minecraft:item_display,tag=bp.sanctum_exit] run function bracken:dimension_crossing/spawn_platforms/sanctum_to_overworld
