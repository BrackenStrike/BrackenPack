...
execute if data block ~ ~ ~ {Items:[{Slot:3b,id:"minecraft:nether_wart",components:{"minecraft:custom_data":{bp:{id:"potion_recipe"}}}},{components:{"minecraft:potion_contents":{potion:"minecraft:awkward"}}}]} run function bracken:dimension_commands/other/brine_brewing/ingredients
