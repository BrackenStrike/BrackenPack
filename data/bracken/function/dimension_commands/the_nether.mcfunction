...
# travel underdark
execute if score @s bp.1_second matches 19 if data storage bracken:config {dimension_travel: true} if entity @s[y=300,dy=100] run function bracken:dimension_crossing/nether_to_underdark
