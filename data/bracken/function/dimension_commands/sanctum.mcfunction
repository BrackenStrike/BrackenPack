...
effect give @s[predicate=!bracken:sneak,y=257,dy=100] levitation 1 2 true
...
execute if entity @e[distance=..26,type=minecraft:item_display,tag=bp.sanctum_exit] run function bracken:dimension_commands/other/sanctum_exit_portal
