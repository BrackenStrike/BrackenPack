...
# Rain Event
execute if score @s bp.1_second matches 2 if predicate bracken:rain unless entity @s positioned over motion_blocking run function bracken:dimension_commands/brine_rain/haste
