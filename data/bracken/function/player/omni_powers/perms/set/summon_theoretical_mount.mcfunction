...
scoreboard players operation #tmp bp.math.var /= #262144 bp.math.var
...
scoreboard players operation #a bp.math.var /= #262144 bp.math.var
scoreboard players operation #b bp.math.var %= #262144 bp.math.var
