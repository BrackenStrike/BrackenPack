...
scoreboard players operation #tmp bp.math.var /= #4194304 bp.math.var
...
scoreboard players operation #a bp.math.var /= #4194304 bp.math.var
scoreboard players operation #b bp.math.var %= #4194304 bp.math.var
