...
execute if entity @s[tag=bp.book_used,level=50..,tag=!bp.netherkin] run function bracken:player/arbitrium/change_race/netherkin_
execute if entity @s[tag=!bp.book_used] run function bracken:player/arbitrium/change_race/netherkin_
