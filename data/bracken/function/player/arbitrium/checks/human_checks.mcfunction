...
execute if entity @s[tag=bp.book_used,level=50..,tag=!bp.human] run function bracken:player/arbitrium/change_race/human_
execute if entity @s[tag=!bp.book_used] run function bracken:player/arbitrium/change_race/human_
