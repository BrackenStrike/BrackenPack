...
execute if entity @s[tag=bp.book_used,level=50..,tag=!bp.faefolk] run function bracken:player/arbitrium/change_race/faefolk_
execute if entity @s[tag=!bp.book_used] run function bracken:player/arbitrium/change_race/faefolk_
