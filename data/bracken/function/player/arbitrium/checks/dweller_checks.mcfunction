...
execute if entity @s[tag=bp.book_used,level=50..,tag=!bp.dweller] run function bracken:player/arbitrium/change_race/dweller_
execute if entity @s[tag=!bp.book_used] run function bracken:player/arbitrium/change_race/dweller_
