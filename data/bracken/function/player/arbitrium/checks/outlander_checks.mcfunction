...
execute if entity @s[tag=bp.book_used,level=50..,tag=!bp.outlander] run function bracken:player/arbitrium/change_race/outlander_
execute if entity @s[tag=!bp.book_used] run function bracken:player/arbitrium/change_race/outlander_
