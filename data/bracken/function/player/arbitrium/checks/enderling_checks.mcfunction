...
execute if entity @s[tag=bp.book_used,level=50..,tag=!bp.enderling] run function bracken:player/arbitrium/change_race/enderling_
execute if entity @s[tag=!bp.book_used] run function bracken:player/arbitrium/change_race/enderling_
