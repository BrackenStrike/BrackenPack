...
tellraw @s[tag=bp.book_used,tag=bp.frostkin] ["",{"translate":"You are already a "},{"translate":"Frostkin","color":"aqua"},{"translate":"!"}]
tellraw @s[tag=bp.book_used,level=..49,tag=!bp.frostkin] "You do not have enough levels to use Book of Arbitrium."
