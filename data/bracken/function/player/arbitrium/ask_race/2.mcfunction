...
{"translate":"Click here to change species.","bold":true,"underlined":true,"color":"white","click_event":{"action":"run_command","command":"/trigger bp.species_selected set 102"}},\
{"translate":"\n------------------------------"}]