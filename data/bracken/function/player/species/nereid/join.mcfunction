...
attribute @s minecraft:oxygen_bonus modifier add bracken:nereid.oxygen_bonus 89 add_value
attribute @s minecraft:gravity modifier add bracken:nereid.gravity 0.15 add_multiplied_base
