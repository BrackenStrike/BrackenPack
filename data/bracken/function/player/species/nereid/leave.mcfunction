...
attribute @s minecraft:generic.gravity modifier add bracken:nereid.gravity
attribute @s minecraft:generic.step_height modifier add bracken:nereid.step_height
