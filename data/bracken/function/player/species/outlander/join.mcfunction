...
execute if data storage bracken:config {teams_on:true} run team join bp.Outlander
...
attribute @s minecraft:sneaking_speed modifier add bracken:outlander.sneaking_speed 1 add_multiplied_base
