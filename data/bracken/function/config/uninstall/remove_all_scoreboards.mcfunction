...
scoreboard objectives remove bp.10_second
...
#Boss scores
scoreboard objectives remove bp.boss_health
scoreboard objectives remove bp.boss_state_cd
scoreboard objectives remove bp.boss_1
scoreboard objectives remove bp.boss_2
scoreboard objectives remove bp.boss_3
scoreboard objectives remove bp.boss_move_state
scoreboard objectives remove bp.boss_speed
scoreboard objectives remove bp.boss_end
...
scoreboard objectives remove bp.sporangium.health

scoreboard objectives remove bp.unsung
scoreboard objectives remove bp.speed
scoreboard objectives remove bp.slash
scoreboard objectives remove bp.unsung.health

scoreboard objectives remove bp.kraken
scoreboard objectives remove bp.spin
scoreboard objectives remove bp.sploosh
scoreboard objectives remove bp.sploosh2
scoreboard objectives remove bp.kraken.health

scoreboard objectives remove bp.fae_emperor
scoreboard objectives remove bp.fae_emperor.health
scoreboard objectives remove bp.arrowrain
...
scoreboard objectives remove bp.conduit
scoreboard objectives remove bp.dimension_check
...
### Omnidrome Commands ###
scoreboard objectives remove OMNI.BUILD.cube 
scoreboard objectives remove OMNI.BUILD.road_north 
scoreboard objectives remove OMNI.BUILD.road_south 
scoreboard objectives remove OMNI.BUILD.road_east 
scoreboard objectives remove OMNI.BUILD.road_west 
scoreboard objectives remove OMNI.BUILD.pillar 
scoreboard objectives remove OMNI.BUILD.cyber_tree 
scoreboard objectives remove OMNI.BUILD.pyramid 
scoreboard objectives remove OMNI.BUILD.end_island 
scoreboard objectives remove OMNI.BUILD.sculk_patch 
scoreboard objectives remove OMNI.BUILD.single_block 

scoreboard objectives remove OMNI.CLEAR.debris 
scoreboard objectives remove OMNI.CLEAR.material 

scoreboard objectives remove OMNI.SUMMON.lightning 
scoreboard objectives remove OMNI.SUMMON.construct 
scoreboard objectives remove OMNI.SUMMON.theoretical_blaze 
scoreboard objectives remove OMNI.SUMMON.theoretical_creeper 
scoreboard objectives remove OMNI.SUMMON.theoretical_mount 
scoreboard objectives remove OMNI.SUMMON.theoretical_ravager 
scoreboard objectives remove OMNI.SUMMON.theoretical_tnt 
scoreboard objectives remove OMNI.SUMMON.theoretical_pirate 
scoreboard objectives remove OMNI.SUMMON.theoretical_snowman 
scoreboard objectives remove OMNI.SUMMON.theoretical_warden 
scoreboard objectives remove OMNI.SUMMON.pulse 
scoreboard objectives remove OMNI.SUMMON.disruptor_beam 

scoreboard objectives remove OMNI.ENABLE.flight 
scoreboard objectives remove OMNI.ENABLE.sprint 
scoreboard objectives remove OMNI.DISABLE.flight 
scoreboard objectives remove OMNI.DISABLE.sprint 

scoreboard objectives remove OMNI.TELEPORT.to_nearest_nearby_player 

scoreboard objectives remove OMNI.ASK.help 

################################################################################

scoreboard objectives remove _OMNI.BUILD.cube 
scoreboard objectives remove _OMNI.BUILD.road_north 
scoreboard objectives remove _OMNI.BUILD.road_south 
scoreboard objectives remove _OMNI.BUILD.road_east 
scoreboard objectives remove _OMNI.BUILD.road_west 
scoreboard objectives remove _OMNI.BUILD.pillar 
scoreboard objectives remove _OMNI.BUILD.cyber_tree 
scoreboard objectives remove _OMNI.BUILD.pyramid 
scoreboard objectives remove _OMNI.BUILD.end_island 
scoreboard objectives remove _OMNI.BUILD.sculk_patch 
scoreboard objectives remove _OMNI.BUILD.single_block 

scoreboard objectives remove _OMNI.CLEAR.debris 
scoreboard objectives remove _OMNI.CLEAR.material 

scoreboard objectives remove _OMNI.SUMMON.lightning 
scoreboard objectives remove _OMNI.SUMMON.construct 
scoreboard objectives remove _OMNI.SUMMON.theoretical_blaze 
scoreboard objectives remove _OMNI.SUMMON.theoretical_creeper 
scoreboard objectives remove _OMNI.SUMMON.theoretical_mount 
scoreboard objectives remove _OMNI.SUMMON.theoretical_ravager 
scoreboard objectives remove _OMNI.SUMMON.theoretical_tnt 
scoreboard objectives remove _OMNI.SUMMON.theoretical_pirate 
scoreboard objectives remove _OMNI.SUMMON.theoretical_snowman 
scoreboard objectives remove _OMNI.SUMMON.theoretical_warden 
scoreboard objectives remove _OMNI.SUMMON.pulse 
scoreboard objectives remove _OMNI.SUMMON.disruptor_beam 

scoreboard objectives remove _OMNI.ENABLE.flight 
scoreboard objectives remove _OMNI.ENABLE.sprint 
scoreboard objectives remove _OMNI.DISABLE.flight 
scoreboard objectives remove _OMNI.DISABLE.sprint 

scoreboard objectives remove _OMNI.ASK.help 

scoreboard objectives remove OMNI.POWER.adamantine_will 
scoreboard objectives remove OMNI.POWER.crimson_spark 
scoreboard objectives remove OMNI.POWER.fang_attack 
scoreboard objectives remove OMNI.POWER.fireball 
scoreboard objectives remove OMNI.POWER.flying_boat 
scoreboard objectives remove OMNI.POWER.frostlock 
scoreboard objectives remove OMNI.POWER.great_nullifier 
scoreboard objectives remove OMNI.POWER.iron_golem 
scoreboard objectives remove OMNI.POWER.kill 
scoreboard objectives remove OMNI.POWER.travel_call 
scoreboard objectives remove OMNI.POWER.mansion 
scoreboard objectives remove OMNI.POWER.mass_heal 
scoreboard objectives remove OMNI.POWER.recall 
scoreboard objectives remove OMNI.POWER.scatterstorm 
scoreboard objectives remove OMNI.POWER.swordfall 
scoreboard objectives remove OMNI.POWER.tetra_slime 
scoreboard objectives remove OMNI.POWER.truelight_glow 
scoreboard objectives remove OMNI.POWER.world_soar 
scoreboard objectives remove OMNI.POWER.worm_toothed_burrower 

scoreboard objectives remove _OMNI.POWER.adamantine_will 
scoreboard objectives remove _OMNI.POWER.crimson_spark 
scoreboard objectives remove _OMNI.POWER.fang_attack 
scoreboard objectives remove _OMNI.POWER.fireball 
scoreboard objectives remove _OMNI.POWER.flying_boat 
scoreboard objectives remove _OMNI.POWER.frostlock 
scoreboard objectives remove _OMNI.POWER.great_nullifier 
scoreboard objectives remove _OMNI.POWER.iron_golem 
scoreboard objectives remove _OMNI.POWER.kill 
scoreboard objectives remove _OMNI.POWER.travel_call 
scoreboard objectives remove _OMNI.POWER.mansion 
scoreboard objectives remove _OMNI.POWER.mass_heal 
scoreboard objectives remove _OMNI.POWER.recall 
scoreboard objectives remove _OMNI.POWER.scatterstorm 
scoreboard objectives remove _OMNI.POWER.swordfall 
scoreboard objectives remove _OMNI.POWER.tetra_slime 
