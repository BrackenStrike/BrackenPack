...
execute if score @s bp.brine_potion matches 104 run data modify block ~ ~ ~ Items[{Slot:2b}] merge value {components:{"minecraft:potion_contents":{custom_effects:[{duration:4800,id:"strength",amplifier:0}]},"minecraft:custom_data":{bp:[{id:"potion_modified1"},{id:"check"},{greed_duration:1b},{greed_amplifier:0b}]}}}
