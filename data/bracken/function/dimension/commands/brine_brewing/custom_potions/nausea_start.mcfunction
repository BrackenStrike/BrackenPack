...
execute if block ~ ~ ~ brewing_stand{Items:[{Slot:0b,components:{"minecraft:potion_contents":{potion:"minecraft:awkward"}}}]} run data modify block ~ ~ ~ Items[{Slot:0b,components:{"minecraft:potion_contents":{potion:"minecraft:awkward"}}}] merge value {components:{"minecraft:custom_name":"Potion of Nausea","minecraft:potion_contents":{custom_color:6758078,custom_effects:[{duration:400,id:"nausea"}]},"minecraft:custom_data":{bp.potion:107b,bp:[{id:"custom_potion"},{closed_path:"enhance"}]}}}
