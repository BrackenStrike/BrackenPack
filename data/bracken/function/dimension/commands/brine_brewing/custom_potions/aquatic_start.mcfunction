...
execute if block ~ ~ ~ brewing_stand{Items:[{Slot:0b,components:{"minecraft:potion_contents":{potion:"minecraft:awkward"}}}]} run data modify block ~ ~ ~ Items[{Slot:0b,components:{"minecraft:potion_contents":{potion:"minecraft:awkward"}}}] merge value {components:{"minecraft:custom_name":"Potion of Aquatic Enhancement","minecraft:potion_contents":{custom_color:4047815,custom_effects:[{duration:3600,id:"dolphins_grace"},{duration:3600,id:"conduit_power"}]},"minecraft:custom_data":{bp.potion:101b,bp:[{id:"custom_potion"},{closed_path:"enhance"}]}}}
