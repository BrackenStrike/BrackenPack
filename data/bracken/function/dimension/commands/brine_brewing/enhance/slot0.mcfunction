...
# Unique Potions
execute if data block ~ ~ ~ Items[{Slot:0b,components:{"minecraft:custom_data":{bp.potion:104b}}}] store result block ~ ~ ~ Items[{Slot:0b}].components."minecraft:custom_data".bp[2].greed_amplifier byte 1 run data get block ~ ~ ~ Items[{Slot:0b}].components."minecraft:potion_contents".custom_effects[{id:"minecraft:strength"}].amplifier
