...
# 102
# 103
execute if score @s bp.brine_potion matches 104 run data modify block ~ ~ ~ Items[{Slot:2b}] merge value {components:{"minecraft:potion_contents":{custom_effects:[{duration:900,id:"strength",amplifier:1}]},"minecraft:custom_data":{bp:[{id:"potion_modified1"},{id:"check"},{greed_duration:0b},{greed_amplifier:1b}]}}}
