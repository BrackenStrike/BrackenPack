...
execute if data block ~ ~ ~ Items[{Slot:2b}].components."minecraft:potion_contents".custom_effects[{id:"invisibility"}] run data modify block ~ ~ ~ Items[{Slot:2b}].components."minecraft:potion_contents".custom_effects[{id:"invisibility"}].show_particles set value 0b
