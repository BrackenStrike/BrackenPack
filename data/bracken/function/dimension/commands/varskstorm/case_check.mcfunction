...
execute if data storage bracken:var {varskstorm:{stage:3}} if score #cooldown bp.varskstorm matches ..0 if block ~ ~-1 ~ lightning_rod run function bracken:dimension/commands/varskstorm/spawn_thunderbolt {range:5}
execute if data storage bracken:var {varskstorm:{stage:3}} if score #cooldown bp.varskstorm matches ..0 unless block ~ ~-1 ~ lightning_rod run function bracken:dimension/commands/varskstorm/spawn_thunderbolt {range:50}
