...
execute if score #count bp.varskstorm matches 6 if data storage bracken:var {varskstorm:{stage:2}} run playsound bracken:varskspace music @a[distance=..100] ~ ~ ~ 100 1 0
