...
execute if score #count bp.varskstorm matches 6 if data storage bracken:var {varskstorm:{stage:2}} run function bracken:dimension/commands/varskstorm/music
