...
#brine conduit back
execute if data storage bracken:config {dimension_travel: true} if score @s bp.1_second matches 5 if entity @s[predicate=bracken:effect/conduit_power] run function bracken:dimension/commands/other/conduit_raycast2
