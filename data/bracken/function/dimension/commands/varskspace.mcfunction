...
# Dimension Travel
execute if score @s bp.1_second matches 14 if data storage bracken:config {dimension_travel: true} if entity @s[scores={bp.ice=7..}] run function bracken:dimension/crossing/overworld_to_glacium
