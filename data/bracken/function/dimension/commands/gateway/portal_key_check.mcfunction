...
execute if data storage bracken:config {portal_keys_on: true} as @e[type=minecraft:marker,tag=bp.pax_scores,distance=..25,limit=1] run function bracken:dimension/commands/gateway/remove_key_tags
