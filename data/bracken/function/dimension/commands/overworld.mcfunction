...
execute if score @s bp.creeper matches 1 if data storage bracken:config {dimension_travel:true} if entity @e[type=minecraft:creeper,distance=..1] run return run function bracken:dimension/crossing/overworld_to_panacea
