...
execute if score #1 bp.math.out matches 0 run playsound minecraft:entity.elder_guardian.death weather @s ~ ~ ~ 100 0

execute if score #1 bp.math.out matches 1 run effect give @s minecraft:levitation 1 5 true
execute if score #1 bp.math.out matches 1 run playsound minecraft:entity.elder_guardian.death weather @s ~ ~ ~ 150 0
...
execute if score #1 bp.math.out matches 2 run playsound minecraft:entity.elder_guardian.death weather @s ~ ~ ~ 200 0