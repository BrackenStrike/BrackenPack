...
execute unless entity @s[predicate=bracken:light/at_least_5] positioned over motion_blocking if entity @s[predicate=bracken:rain,dy=999] run function bracken:dimension/commands/glacium_storm/blizzard
