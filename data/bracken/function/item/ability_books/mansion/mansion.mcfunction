...
execute unless entity @s[scores={bp.mansion_use=2..}] run tellraw @s[level=..1,tag=bp.set_mansion] {"translate":"You do not have enough levels to use this book."}
execute unless entity @s[scores={bp.mansion_use=2..}] run tellraw @s[level=..19,tag=!bp.set_mansion] {"translate":"You do not have enough levels to use this book."}
