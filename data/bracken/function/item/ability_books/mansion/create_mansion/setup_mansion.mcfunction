...
execute as @e[type=marker,tag=bp.mm_portal,distance=..1,sort=nearest,limit=1] at @s run function bracken:item/ability_books/mansion/portal_linked_coordinates
