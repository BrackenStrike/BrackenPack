...
execute if entity @s[tag=bp.mansion_2] as @e[type=marker,tag=bp.mansion,limit=1,sort=nearest,predicate=bracken:dimensions/void] at @s run function bracken:item/ability_books/mansion/create_mansion/tp_to_mansion_first
