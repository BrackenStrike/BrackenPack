...
execute if entity @s[tag=bp.from_mansion_2] as @e[type=marker,tag=bp.mm_portal3,limit=1,sort=nearest] at @s run function bracken:item/ability_books/mansion/tp_from_mansion/tp_back_execution
