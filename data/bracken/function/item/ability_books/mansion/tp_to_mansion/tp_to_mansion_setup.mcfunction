...
execute if entity @s[tag=bp.to_mansion_2] as @e[type=marker,tag=bp.mm_portal1,limit=1,sort=nearest,predicate=bracken:dimensions/void] at @s run function bracken:item/ability_books/mansion/tp_to_mansion/tp_to_mansion
