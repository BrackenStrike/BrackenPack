...
execute if score @p[distance=..1] bp.mansion_id = @s[scores={bp.mansion_use=0}] bp.mansion_id as @p run function bracken:item/ability_books/mansion/create_mansion/setup_mansion
