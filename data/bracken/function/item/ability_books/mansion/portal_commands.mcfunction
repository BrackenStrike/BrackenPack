...
execute if entity @p[distance=..1] if entity @s[scores={bp.mansion_use=1}] as @p run function bracken:item/ability_books/mansion/tp_to_mansion/tp_to_mansion_start
execute if score @p[distance=..1] bp.world_player_id = @s[scores={bp.mansion_use=0}] bp.world_player_id as @p run function bracken:item/ability_books/mansion/create_mansion/setup_mansion

scoreboard players add @s bp.tick 1
execute at @s[scores={bp.tick=9600..}] run function bracken:item/ability_books/mansion/destroy_portal
