...
execute if predicate bracken:sneak if entity @e[type=birch_boat,distance=..5] run function bracken:item/ability_books/flying_boat/destroy
execute unless predicate bracken:sneak anchored eyes run function bracken:item/ability_books/flying_boat/raycast_summon
