...
execute at @e[limit=1,sort=nearest,type=minecraft:giant,tag=bp.sword,distance=..30] positioned ^1.5 ^1.8 ^5 if entity @e[type=!minecraft:item,distance=..2] run function bracken:item/ability_books/swordfall/damage
