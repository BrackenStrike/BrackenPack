...
##########################################################
playsound minecraft:item.goat_horn.sound.1 player @a[distance=..30] ~ ~ ~ 10 1
playsound minecraft:item.goat_horn.sound.1 player @a[distance=..30] ~ ~ ~ 10 1.5
playsound minecraft:item.goat_horn.sound.1 player @a[distance=..30] ~ ~ ~ 10 1.25
